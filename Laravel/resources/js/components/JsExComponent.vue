<template>
  <div>
    ...
    <div>RoundCount : {{ rounds.length }}</div>
    <div
...
export default {
  ...
  mounted: function () {
    ...
    for (var j = 0; j < this.data.length; j++) {
      this.group[this.data[j].round - 1].push(this.data[j])
