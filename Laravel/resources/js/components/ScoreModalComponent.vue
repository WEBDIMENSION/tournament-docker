<template>
    <!-- モーダルウィンドウ外枠 -->
    <div class="modal" v-bind:modalid="[modalId]" tabindex="-1" role="dialog"
         v-bind:exampleModalLabel="[exampleModalLabel]" v-bind:id="[exampleModalLabelId]" aria-hidden="true">
        <!-- モーダルのダイアログ本体 -->
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <!-- モーダルのタイトル -->
                    <h5 class="modal-title" v-bind:id="[exampleModalLabelId]">
                        <!--                        {{$event->event_name}}-->
                ...
                <div class="modal-body row">
                    ...
                    <!--                            <input type="checkbox" id="radio1" class="form-check-input" name="winner"-->
                    <!--                                   value="{{$card->player_a_id}}" v-model="winner">-->
                    ...
                    <!--                        </div>-->
                    <!--                        <div class="form-check">-->
                    <!--                            <input type="checkbox" id="radio2" class="form-check-input" name="winner"-->
                    <!--                                   value="{{$card->player_b_id}}" v-model="winner">-->
                    <!--                            <label class="form-check-label" for="radio1">-->
                    ...
                    <div class="col-md-4">
                        Score
                        <!--                        <input type="text" name="score" value="{{$card->score}}" v-model="score">-->
                    </div>
                    <div class="col-md-4">
                ...
                <div class="modal-footer">
                    <!-- 閉じるボタン -->
                    <button type="button" v-on:click="post">Send</button>
...
<script>
    export default {
        props: {
            ...
            cardid: String,
            modalId: String,
            exampleModalLabel: String,
            exampleModalLabelId: String,
        ...
        created: function () {
            ...
            // console.log(this.card2.id)
        },
        mounted: function () {
            this.card = JSON.parse(this.card);
            // this.ardid = this.card.id;
        },
        methods: {
            post: function (event) {
            }
